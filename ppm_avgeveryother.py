...
w = w//4                            #Set width and height for after blur/average
h = h//4
...
for i in range(0, len(r)//4, 2):          #Average all the colors
    index = 2 * i
    index2 = 2 * i + 1
...
f = open("C:/Users/myuser/Documents/path/avgeveryother.ppm", "w+")        #Create, format, and write to new ppm file
f.write(ppmformat + "\n" + str(w) + " " + str(h) + "\n" + str(maxval) + "\n")
